...
Configuration for CERES Simplified system
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-ceres-simplified-dev-key-change-in-production')
